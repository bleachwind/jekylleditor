...
var postArr = [{
    ...
    comments: [{
        name: 'Rick',
        message: 'Can I join in?'
    }, {
        name: 'Mark',
        message: 'Enjoying working with this team!'
    }, {
        name: 'Lakshmi',
        message: 'Why another todo list app?'
    }]
}, {
    id: 2,
    ...
    comments: [{
        ...
        name: 'Daniel',
        message: 'I am learning Android development now. Can I join in?'
    }]
}, {
    id: 3,
    ...
    comments: [{
        name: 'John',
        message: 'Started using it last week and it is nice so far'
    }, {
        name: 'Jessica',
        message: 'I am running because of this app. Thanks!'
    }]
}, {
    id: 5,
    name: 'Daily Expenses',
    ...
    comments: [{
        ...
        name: 'Sean',
        message: 'I just joined this team and it is awesome so far!'
    }, {
        name: 'Ken',
...
exports.getPost = function(id) {
    var post = _.find(postArr, function(item) {
        return item.id == id;
    });
    return post;
};